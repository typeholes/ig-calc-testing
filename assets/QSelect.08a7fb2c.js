import { ao as onBeforeUnmount, al as nextTick, bu as noop, k as ref, Q as computed, aY as watch, bP as debounce, an as onBeforeMount, aq as onDeactivated, am as onActivated, ac as h, a9 as getCurrentInstance, af as inject, cx as formKey, bO as injectProp, ap as onBeforeUpdate, bt as stopAndPrevent, as as onMounted, cs as isRuntimeSsrPreHydration, cr as prevent, b6 as Transition, br as isKeyCode, bx as addEvt, bA as cleanEvt, bI as listenOpts, cy as globalConfig, aw as onUnmounted, T as Teleport, bv as client, bz as position, cz as isDeepEqual, ax as onUpdated, bU as stop, bs as shouldIgnoreKey } from "./index.0bf009a8.js";
import { u as useSizeProps, c as createComponent, f as useSize, q as hMergeSlotSafely, Q as QIcon, k as QSpinner, a as hSlot, d as hDir, R as Ripple, j as useRouterLinkProps, r as useRouterLink, e as hUniqueSlot, s as getParentVm, w as childHasFocus, h as hMergeSlot } from "./QBtn.f303d055.js";
import { e as between, a as useDarkProps, b as useDark, c as clearSelection, w as getScrollbarWidth, k as useModelToggleProps, l as useModelToggleEmits, u as useTimeout, m as useModelToggle, d as getScrollTarget, x as useHistory, y as usePreventScroll, z as normalizeToInterval } from "./QLayout.4d2c4661.js";
function useTick() {
  let tickFn;
  onBeforeUnmount(() => {
    tickFn = void 0;
  ...
  setup(props, { slots, emit }) {
    ...
    Object.assign(state, {
      ...
      floatingLabel: computed(
        () => props.hideSelected !== true && hasValue.value === true || inputValue.value.length > 0 || fieldValueIsFilled(props.displayValue)
      ),
      getControlChild: () => {
...
export { testPattern as A, QSelect as Q, useVirtualScrollProps as a, useVirtualScroll as b, useFormProps as c, useFormInject as d, commonVirtPropsList as e, useAnchorProps as f, useAnchor as g, QDialog as h, QMenu as i, useFieldProps as j, useFieldEmits as k, useFormInputNameAttr as l, fieldValueIsFilled as m, useFieldState as n, useField as o, useKeyComposition as p, addFocusFn as q, rtlHasScrollBug as r, QItem as s, useFormAttrs as t, useTick as u, getPortalVm as v, closePortals as w, uid as x, QItemLabel as y, QItemSection as z };
